...
def main():
    ...
    parser_show = subparsers.add_parser("show", help="Show the presentation")
    parser_show.add_argument("presentation",  help = "Presentation file to show")
    parser_show.add_argument("-s", "--slide", help = "Start at slide num (0 indexed)", default = 0)
